...
//
//////////////////////////////////////////////////////////////////////////////////////////
func GetData(stub shim.ChaincodeStubInterface, function string, args []string) pb.Response {

	var err error

	// Get the Object and Display it
	Avalbytes, err := itpUtils.QueryObject(stub, "Data", args)
	if err != nil {
		fmt.Println("GetData() : Failed to Query Object ")
...
func CreateDataObject(args []string) (UserObject, error) {
	...
	// Check there are 11 Arguments
	if len(args) != 11 {
		fmt.Println("CreateDataObject(): Incorrect number of arguments. Expecting 11 ")
		return aData, errors.New("CreateDataObject() : Incorrect number of arguments. Expecting 11 ")
	}
	...
	fmt.Println("CreateDataObject() : Data Object : ", aData)
...
func PostData(stub shim.ChaincodeStubInterface, function string, args []string) pb.Response {
